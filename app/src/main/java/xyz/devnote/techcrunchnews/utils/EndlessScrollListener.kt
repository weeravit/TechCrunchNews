package xyz.devnote.techcrunchnews.utils
...
// credit: https://gist.github.com/nesquena/d09dc68ff07e845cc622
class EndlessScrollListener : RecyclerView.OnScrollListener {
    ...
    constructor(layoutManager: LinearLayoutManager, listener: Listener) {
    ...
    override fun onScrolled(view: RecyclerView, dx: Int, dy: Int) {
        ...
        if (!loading && lastVisibleItemPosition + visibleThreshold > totalItemCount) {
            currentPage++
            listener.onLoadMore(currentPage + 1, totalItemCount, view)
            loading = true
        }
    }
